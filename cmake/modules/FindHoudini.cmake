...
foreach(HOUDINI_LIB_DEP
    ...
    find_library(HOUDINI_${HOUDINI_LIB_DEP}_LIBRARY
        ...
        HINTS
            "${HOUDINI_LIB_DIRS}"
        DOC
            "Houdini's ${HOUDINI_LIB_DEP} library path"
        NO_CMAKE_SYSTEM_PATH
    )

    if (HOUDINI_${HOUDINI_LIB_DEP}_LIBRARY)
        list(APPEND HOUDINI_LIBRARIES_DEPS ${HOUDINI_${HOUDINI_LIB_DEP}_LIBRARY})
    endif ()
endforeach()
...
if(HOUDINI_INCLUDE_DIRS AND EXISTS "${HOUDINI_INCLUDE_DIRS}/pxr/pxr.h")
    foreach(_usd_comp MAJOR MINOR PATCH)
        file(STRINGS
            "${HOUDINI_INCLUDE_DIRS}/pxr/pxr.h"
            _usd_tmp
