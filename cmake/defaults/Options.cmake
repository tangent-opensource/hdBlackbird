...
option(PXR_BUILD_CYCLES_PLUGIN "Build the PRMan imaging plugin" ON)
...
if (${PXR_BUILD_CYCLES_PLUGIN})
    if (NOT ${PXR_BUILD_IMAGING})
        message(STATUS
            "Setting PXR_BUILD_CYCLES_PLUGIN=OFF because PXR_BUILD_IMAGING=OFF")
        set(PXR_BUILD_CYCLES_PLUGIN "OFF" CACHE BOOL "" FORCE)
    endif()
endif()
