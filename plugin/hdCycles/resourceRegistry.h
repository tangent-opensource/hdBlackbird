...
public:
    ...
    std::vector<HdCyclesSceneBindingSharedPtr> BindShaders(const std::vector<ccl::Shader*>& shaders);
...
private:
    ...
    HdInstanceRegistry<HdCyclesSceneBindingSharedPtr> m_shader_bindings;
};
