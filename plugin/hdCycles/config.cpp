...
HdCyclesConfig::HdCyclesConfig()
{
    ...
    texture_use_cache = HdCyclesEnvValue<bool>("HD_BLACKBIRD_TEXTURE_USE_CACHE", true);
    texture_cache_size = HdCyclesEnvValue<int>("HD_BLACKBIRD_TEXTURE_CACHE_SIZE", 2048);
    ...
    texture_accept_unmipped = HdCyclesEnvValue<bool>("HD_BLACKBIRD_TEXTURE_ACCEPT_UNMIPPED", true);
    texture_accept_untiled = HdCyclesEnvValue<bool>("HD_BLACKBIRD_TEXTURE_ACCEPT_UNTILED", true);
